...
# Daisy Pandey, September 8, 2020, Modified method and added code to read/write text file
# Daisy Pandey, September 9, 2020, Updated docstrings
#------------------------------------------#
...
class FileIO:
    ...
    def load_inventory(file_name: list) -> list:
        """Function to manage data ingestion to text file
